...
abstract class BaseMovie extends Movie implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Enjoy\\MovieBundle\\Model\\MoviePeer';
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = MoviePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = MoviePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MoviePeer::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MoviePeer::NAME)) $criteria->add(MoviePeer::NAME, $this->name);
