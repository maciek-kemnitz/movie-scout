...
namespace Enjoy\MovieBundle\Model\om;
...
use \PropelException;
use \PropelPDO;
use Enjoy\MovieBundle\Model\Movie;
use Enjoy\MovieBundle\Model\MoviePeer;
use Enjoy\MovieBundle\Model\map\MovieTableMap;
...
abstract class BaseMoviePeer
{
    ...
    const OM_CLASS = 'Enjoy\\MovieBundle\\Model\\Movie';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Enjoy\\MovieBundle\\Model\\map\\MovieTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of Movie objects.
     ...
     * e.g. MoviePeer::$fieldNames[MoviePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', ),
        BasePeer::TYPE_COLNAME => array (MoviePeer::ID, MoviePeer::NAME, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. MoviePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, ),
        BasePeer::TYPE_COLNAME => array (MoviePeer::ID => 0, MoviePeer::NAME => 1, ),
    ...
    {
        $toNames = MoviePeer::getFieldNames($toType);
        $key = isset(MoviePeer::$fieldKeys[$fromType][$name]) ? MoviePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(MoviePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, MoviePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return MoviePeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MoviePeer::NAME);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MoviePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MoviePeer::DATABASE_NAME);
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(MoviePeer::$instances[$key])) {
                return MoviePeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (MoviePeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        MoviePeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(MoviePeer::DATABASE_NAME)->getTable(MoviePeer::TABLE_NAME);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseMoviePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Enjoy\MovieBundle\Model\map\MovieTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(MoviePeer::DATABASE_NAME);
