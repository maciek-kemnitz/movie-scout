...
use Enjoy\MovieBundle\Model\MovieQuery;

/**
 * @method MovieQuery orderById($order = Criteria::ASC) Order by the id column
 * @method MovieQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method MovieQuery groupById() Group by the id column
 * @method MovieQuery groupByName() Group by the name column
 *
 ...
 *
 * @method Movie findOneByName(string $name) Return the first Movie filtered by the name column
 *
 * @method array findById(int $id) Return Movie objects filtered by the id column
 * @method array findByName(string $name) Return Movie objects filtered by the name column
 */
abstract class BaseMovieQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Enjoy\\MovieBundle\\Model\\Movie';
        }
     ...
     * @param   MovieQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return MovieQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new MovieQuery(null, null, $modelAlias);
     ...
     *
     * @return   Movie|Movie[]|mixed the result, formatted by the current formatter
     */
    ...
    {
        $sql = 'SELECT `id`, `name` FROM `movie` WHERE `id` = :p0';
        try {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new Movie();
            $obj->hydrate($row);
            MoviePeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Movie[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(MoviePeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(MoviePeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(MoviePeer::NAME, $name, $comparison);
    }
